...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        backspace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!string.isEmpty()){
                    ...
                    String txtEmpressao = string.substring(var0, var1);
                    expressao.setText(txtEmpressao);
                }
                txtResultado.setText("");
            }
        });
        ...
        igual.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    long longResul = (long) resultado;

                    if (resultado == (double) longResul) {
                        txtResultado.setText((CharSequence) String.valueOf(longResul));
                    } else {
    ...
    private void IniciarComponentes() {
        numeroZero = findViewById(R.id.numero_nove);
